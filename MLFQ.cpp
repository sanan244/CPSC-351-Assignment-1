...
int main()
{
    ...
    do
    {
        ...
        std::cout << "executing process: " << current0_process.id << " in queue " << current0_process.qnum << std::endl
                  << std::endl;
        for (int i = 0; i < tq0; i++)
        {
        ...
        {
            complete_time += tq0 + 1; // for loop starts with i = 1
    ...
    std::cout << p1_queue.front().bt << std::endl
              << std::endl;
    std::cout << p1_queue.back().bt << std::endl
              << std::endl;
    ...
    do
    {
        ...
        for (int i = 0; i < tq1; i++)
        {
            ...
            {
                complete_time += i + 1; // for loop starts with i = 1
        ...
        std::cout << " burst time after queue 0 is: " << current1_process.bt << std::endl
                  << std::endl;
        p1_queue.pop();
